...
const Testimonial = ({ quote, name, position, company }: TestimonialProps) => {
  return (
    <SpotlightCard className="bg-bgLight rounded-lg p-8 border border-white/10 h-full flex flex-col">
      <div className="mb-6 primary-accent">
      ...
      <p className="avalon mb-6 flex-grow">{quote}</p>
      <div>
        <p className="avalon-bold">{name}</p>
        <p className="avalon text-sm">{position} @ {company}</p>
      </div>
    </SpotlightCard>
  );
};
...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-40 bg-bgDark">
      <div className="container mx-auto max-w-7xl px-5">
        <h2 className="avalon-bold text-4xl text-center mb-4">What Our <span className="dual-underline primary-accent">Clients</span> Say</h2>
